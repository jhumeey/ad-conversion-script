...
$(document).ready(function() {
	...
	//Adjust div width
	$("#conversion-rate-worst").on("keydown", function() {
	...
	//Adjust div width
	$("#conversion-rate-worst-mobile").on("keydown", function() {
		let currentVal = $(this).val();
		if (!currentVal) {
			$(this).css('width', '20px');
		} else {
	...
	//Adjust div width
	$("#conversion-rate-moderate").on("keydown", function() {
		let currentVal = $(this).val();
		if (!currentVal) {
			$(this).css('width', '20px');
		} else {
	...
	//Adjust div width
	$("#conversion-rate-moderate-mobile").on("keydown", function() {
		let currentVal = $(this).val();
		if (!currentVal) {
			$(this).css('width', '20px');
		} else {
	...
	//Adjust div width
	$("#conversion-rate-best").on("keydown", function() {
		let currentVal = $(this).val();
		if (!currentVal) {
			$(this).css('width', '20px');
		} else {
	...
	//Adjust div width
	$("#conversion-rate-best-mobile").on("keydown", function() {
		let currentVal = $(this).val();
		if (!currentVal) {
			$(this).css('width', '20px');
		} else {
